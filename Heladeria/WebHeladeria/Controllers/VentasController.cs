...
namespace WebHeladeria.Controllers
{
    public class VentasController : Controller
    {
        ...
        {
            var finalHeladeriaContext = _context.Venta.Include(v => v.IdClienteNavigation).Include(v => v.IdTipoPagoNavigation).Include(v => v.IdUsuarioNavigation);
        ...
        {
            ViewData["IdCliente"] = new SelectList(_context.Clientes, "Id", "Nit");
            ViewData["IdTipoPago"] = new SelectList(_context.TipoPagos, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,IdUsuario,IdCliente,IdTipoPago,MontoTotal,MontoPago,MontoCambio,UsuarioRegistro,FechaRegistro,Estado")] Ventum ventum)
        {
            ...
            ViewData["IdCliente"] = new SelectList(_context.Clientes, "Id", "Nit", ventum.IdCliente);
            ViewData["IdTipoPago"] = new SelectList(_context.TipoPagos, "Id", "Id", ventum.IdTipoPago);
